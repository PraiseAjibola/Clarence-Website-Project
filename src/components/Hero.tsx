...
const Hero = () => {
  return (
    <section className="hero min-h-[75vh] flex flex-col items-center px-8 pt-12 pb-16 text-center relative">
      ...
      <div className="decorative-shape absolute top-[22rem] right-[35%] w-[30vw] max-w-[450px] h-auto opacity-50 -z-10">
